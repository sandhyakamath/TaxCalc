...
public class OrdinaryCitizenJNICaller {

    // load the shared library
    static {
        System.loadLibrary("native");
    }
    public String archetype = "OrdinaryCitizen";
    ...
    public boolean nativeMethodCall(ComputationContext computationContext) {
        ...
        taxDTO.setLiability(new OrdinaryCitizenJNICaller().computeTax(taxDTO));
        return true;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new OrdinaryCitizenJNICaller().computeTax(taxDTO));
    }
}
